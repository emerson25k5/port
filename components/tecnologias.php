<section id="tecnologias">
    ...
    <div class="flex flex-wrap gap-x-3 gap-y-3 justify-between items-center py-6">
        ...
        <div class="w-20">
            <img class="w-20" src="imagens/icons/docker_icon.png" alt="projeto_autcert">
        </div>
        <div class="w-20">
            <img class="w-20" src="imagens/icons/git_icon.png" alt="projeto_autcert">
        </div>
        <div class="w-20">
            <img class="w-20" src="imagens/icons/redis_icon.png" alt="projeto_autcert">
        </div>
    </div>
</section>